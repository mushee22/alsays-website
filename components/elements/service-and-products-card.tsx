...
export default function ServiceAndProductCard({ name, description, services = [], path, btnLabel }:Product) {
    return (
        <div className="border rounded-[40px] gap-7 flex flex-col lg:flex-row p-6 border-grey-100 md:sticky top-0 bg-grey-50">
            <div className="aspect-square h-[352px] lg:w-[352px] bg-grey-100 rounded-3xl">
            </div>
