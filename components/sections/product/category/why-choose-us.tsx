    ...
    <Container className="section-spacing flex flex-col gap-y-6 lg:flex-row justify-between">
      <div className="max-w-[578px] flex flex-col gap-y-5 items-start">
        ...
        <h2 className="heading-md text-primary">
          Collect insights you can trust
        </h2>
        <p className="body-sm text-grey-800">
          Uprooting from the grassroots, we are reshaping the logic behind our
          business approaches by interconnecting the “common good” with a
          healthy organizational ecology. This enables us to fulfil and satisfy
          the needs of all our stakeholders in a sustainable manner by providing
          high-quality product brands and the best services across diverse
          industries, in line with global sustainability goals.
        </p>
        <div className="aspect-[488/466] hidden md:block h-[466px] self-center relative">
          <Image src={WhyChooseUsImage} alt="Why choose us" fill />
        </div>
      </div>
...
const Feature = ({
  ...
  return (
    <div className="flex gap-x-2 items-baseline last:border-0 pb-4 border-b border-grey-100">
      <div>
        <svg
          width={12}
          height={14}
...
const ourFeatures = [
  {
    feature:
      "Proven track record across industrial, commercial, and governmental sectors",
    description:
